...
void WeatherLocation::determineCurrentForecast()
{
    ...
    m_backgroundComponent = QStringLiteral("qrc:/qt/qml/org/kde/kweather/qml/backgrounds/ClearDay.qml");
    ...
    if (currentWeather->weatherIcon() == QStringLiteral("weather-clear")) {
        ...
        m_backgroundComponent = QStringLiteral("qrc:/qt/qml/org/kde/kweather/qml/backgrounds/ClearNight.qml");
        m_topColor = {69, 90, 100}; // "#455a64"
        m_bottomColor = {38, 50, 56}; // "#263238"
        m_star = true;
    } else if (currentWeather->weatherIcon() == QStringLiteral("weather-clouds")) {
        m_backgroundComponent = QStringLiteral("qrc:/qt/qml/org/kde/kweather/qml/backgrounds/CloudyDay.qml");
        isDayStyle = true;
        ...
        m_backgroundComponent = QStringLiteral("qrc:/qt/qml/org/kde/kweather/qml/backgrounds/CloudyNight.qml");
        m_topColor = {69, 90, 100}; // #455a64
        m_bottomColor = {38, 50, 56}; // #263238
        ...
        m_backgroundComponent = QStringLiteral("qrc:/qt/qml/org/kde/kweather/qml/backgrounds/PartlyCloudyDay.qml");
        isDayStyle = true;
        m_topColor = {0, 188, 212}; // #00bcd4
        m_bottomColor = {36, 163, 222}; // #24a3de
        m_cloudColor = {224, 247, 250}; // #e0f7fa
        ...
        m_backgroundComponent = QStringLiteral("qrc:/qt/qml/org/kde/kweather/qml/backgrounds/PartlyCloudyNight.qml");
        m_topColor = {69, 90, 100}; // "#455a64"
        m_bottomColor = {38, 50, 56}; // "#263238"
        m_cloudColor = {176, 190, 197}; // #b0bec5
        m_star = true;
        ...
        m_backgroundComponent = QStringLiteral("qrc:/qt/qml/org/kde/kweather/qml/backgrounds/Misty.qml");
        isDayStyle = true;
        ...
        m_backgroundComponent = QStringLiteral("qrc:/qt/qml/org/kde/kweather/qml/backgrounds/RainyDay.qml");
        isDayStyle = true;
        ...
        m_backgroundComponent = QStringLiteral("qrc:/qt/qml/org/kde/kweather/qml/backgrounds/RainyNight.qml");
        m_backgroundComponent = QStringLiteral("qrc:/qt/qml/org/kde/kweather/qml/backgrounds/CloudyNight.qml");
        m_topColor = {69, 90, 100}; // #455a64
        m_bottomColor = {38, 50, 56}; // #263238
        m_cloudColor = {176, 190, 197}; // #b0bec5
        ...
        m_backgroundComponent = QStringLiteral("qrc:/qt/qml/org/kde/kweather/qml/backgrounds/SnowyDay.qml");
        isDayStyle = true;
        m_topColor = {53, 217, 237}; // #35d9ed
        m_bottomColor = {36, 163, 222}; // #24a3de
        m_snow = true;
    } else if (currentWeather->weatherIcon() == QStringLiteral("weather-snow-scattered-night")) {
        m_backgroundComponent = QStringLiteral("qrc:/qt/qml/org/kde/kweather/qml/backgrounds/SnowyNight.qml");
        m_topColor = {69, 90, 100}; // #455a64
        m_bottomColor = {38, 50, 56}; // #263238
        m_snow = true;
    }
