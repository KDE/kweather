...
public:
    ...
    inline void setWeatherIcon(QString icon){weatherIcon_=icon;};
    inline void setWeatherDescription(QString description){weatherDescription_=description;};
    inline void setDate(QDate date){date_=date;};
